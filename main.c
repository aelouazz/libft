...
// //==================  ft_lstdelone  parameter TEST ======================
// void		del(void * con, size_t size)
// {
// 	*((char *)con) = '\0';
// 	size = 0;
// }
...
int			main(void)
{
	...
	// int a = 42;
	// int *test = &a;
	// t_list *node = ft_lstnew((void const *)test,sizeof(int));
	// //int *print = (int *)node->content;
	// printf("content = %d\nsize = %d",*((int*)node->content) , (int)node->content_size);
